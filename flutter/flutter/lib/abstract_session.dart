...
abstract class AbstractSession extends Session {
  ...
  static Future<FFmpegSession> createFFmpegSession(
    ...
    try {
      ...
      session._sessionId = nativeSession?['sessionId'] as int;
      session._createTime =
          FFmpegKitFactory.validDate(nativeSession?['createTime'] as int?);
      session._startTime =
          FFmpegKitFactory.validDate(nativeSession?['startTime'] as int?);
      session._command = nativeSession?['command'] as String?;
  ...
  static FFmpegSession createFFmpegSessionFromMap(
    ...
    session._sessionId = sessionMap['sessionId'] as int?;
    session._createTime =
        FFmpegKitFactory.validDate(sessionMap['createTime'] as int?);
    session._startTime =
        FFmpegKitFactory.validDate(sessionMap['startTime'] as int?);
    session._command = sessionMap['command'] as String?;
    session._argumentsArray =
        FFmpegKitConfig.parseArguments(sessionMap['command'] as String);
    session._logRedirectionStrategy =
  ...
  static MediaInformationSession createMediaInformationSessionFromMap(
    ...
    if (sessionMap.containsKey('mediaInformation')) {
      session.setMediaInformation(new MediaInformation(
          sessionMap['mediaInformation'] as Map<dynamic, dynamic>));
    }
